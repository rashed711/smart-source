...
const PersonalCareSection: React.FC = () => {
  return (
    <section id="personal-care" className="py-24 bg-sky-50/50">
      <div className="container mx-auto px-4 text-center lg:text-right">
        <div className="flex flex-col lg:flex-row justify-between items-end mb-16 gap-6">
          ...
          <a href="#contact" className="hidden lg:block text-blue-600 font-semibold border-b-2 border-blue-600 pb-1 hover:text-blue-700 hover:border-blue-700 transition-colors">تواصل معنا للاستفسار</a>
        </div>
