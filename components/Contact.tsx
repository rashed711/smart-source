        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-50 p-10 rounded-[2.5rem] border border-slate-100 hover:border-blue-200 hover:bg-white hover:shadow-2xl transition-all duration-500 group">
              ...
              <a href="tel:+201234567890" className="text-blue-600 font-black text-lg flex items-center gap-2 group-hover:gap-4 transition-all flex-row-reverse justify-end">
                +20 123 456 7890
                <ArrowRight size={18} />
              </a>
            </div>
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-blue-100 shadow-2xl shadow-blue-100/20 scale-105 relative z-10 group">
              ...
              <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="text-emerald-600 font-black text-lg flex items-center gap-2 group-hover:gap-4 transition-all flex-row-reverse justify-end">
                ابدأ المحادثة
                <ArrowRight size={18} />
              </a>
            </div>
            ...
            <div className="bg-slate-50 p-10 rounded-[2.5rem] border border-slate-100 hover:border-blue-200 hover:bg-white hover:shadow-2xl transition-all duration-500 group">
              ...
              <a href="mailto:hello@smartsource.com" className="text-slate-900 font-black text-lg flex items-center gap-2 group-hover:gap-4 transition-all flex-row-reverse justify-end">
                hello@smartsource.com
                <ArrowRight size={18} />
              </a>
            </div>
          </div>
          ...
          <div className="mt-20 flex flex-col items-center justify-center text-center p-12 bg-slate-50 rounded-[3rem] border border-slate-100">
            <div className="flex items-center gap-3 mb-4 flex-row-reverse">
              ...
              <span className="font-bold text-slate-900">المقر الرئيسي: القاهرة، جمهورية مصر العربية</span>
            </div>
            <p className="text-slate-500 text-sm">مواعيد العمل: يومياً من 10 صباحاً حتى 10 مساءً</p>
          </div>
        </div>
      </div>
    </section>
